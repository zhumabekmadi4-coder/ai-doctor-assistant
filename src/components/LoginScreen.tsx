...
const AUTH_ERROR_MESSAGES: Record<string, string> = {
    not_registered: 'Аккаунт не найден. Зарегистрируйтесь через Google.',
    already_registered: 'Этот Google-аккаунт уже зарегистрирован. Войдите через Google.',
    account_disabled: 'Аккаунт отключён. Обратитесь к администратору.',
    google_already_linked: 'Этот Google-аккаунт уже привязан к другому аккаунту.',
    denied: 'Вы отменили вход через Google.',
    token_failed: 'Ошибка авторизации Google. Попробуйте снова.',
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-sm animate-fadeInUp">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white/5 border border-white/10 text-gray-400 font-medium rounded-xl hover:bg-white/15 hover:text-white transition-all mt-2"
                >
                    <GoogleIcon />
